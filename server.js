...
app.use((req, res, next) => {
  ...
  res.setHeader('Content-Security-Policy', [
    "default-src 'self'",
    // Google APIs + gstatic needed for Firebase SDK; accounts.google.com for OAuth
    "script-src 'self' 'unsafe-inline' https://www.gstatic.com https://js.paystack.co https://cdnjs.cloudflare.com https://www.googleapis.com https://fonts.googleapis.com https://accounts.google.com",
    ...
    // connect-src: Firebase Auth + Firestore + Paystack + geo providers
    "connect-src 'self' https://api.paystack.co https://firestore.googleapis.com https://identitytoolkit.googleapis.com https://securetoken.googleapis.com https://*.firebaseio.com https://ip-api.com https://ipwho.is https://freeipapi.com https://www.googleapis.com https://paystack.com https://*.paystack.com https://accounts.google.com https://oauth2.googleapis.com https://openidconnect.googleapis.com",
    // frame-src: Firebase auth handler lives on firebaseapp.com; Google OAuth on accounts.google.com
