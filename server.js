 ...
 * TRISEND SERVER v3.2
 * ──────────────────────────────────────────────────────────────
 * CHANGE: Premium is now 30-day renewable, not lifetime.
 *         premiumExpiresAt is set on every successful payment.
 *         Dashboard checks expiry on load and downgrades if lapsed.
 *
